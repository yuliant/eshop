...
class Admin extends CI_Controller
{
	...
	function home()
	{
		if (!empty($this->session->userdata())) {
			...
			$data['title'] = 'Admin - ' . $this->config->item('name_brand');
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - ' . $this->config->item('name_brand');
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - ' . $this->config->item('name_brand');
	...
	function editb_toko_kategoriproduk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - ' . $this->config->item('name_brand');
	...
	function produk()
	{
		$data['title'] = 'Produk - ' . $this->config->item('name_brand');
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - ' . $this->config->item('name_brand');
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function editb_toko_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Produk - ' . $this->config->item('name_brand');
			$data['supp'] = $this->model_app->view_ordering('tb_toko_supplier', 'id_supplier', 'DESC');
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function rekening()
	{
		...
		$data['title'] = 'Rekening - ' . $this->config->item('name_brand');
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - ' . $this->config->item('name_brand');
	...
	function editb_toko_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - ' . $this->config->item('name_brand');
	...
	function supplier()
	{
		...
		$data['title'] = 'Supplier - ' . $this->config->item('name_brand');
		$pengguna = $this->session->id_pengguna;
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - ' . $this->config->item('name_brand');
	...
	function editb_toko_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - ' . $this->config->item('name_brand');
	...
	function konsumen()
	{
		$data['title'] = 'Konsumen - ' . $this->config->item('name_brand');
	...
	function editb_toko_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - ' . $this->config->item('name_brand');
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - ' . $this->config->item('name_brand');
	...
	function pesanan()
	{
		...
		$data['title'] = 'Laporan Pesanan Masuk - ' . $this->config->item('name_brand');
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - ' . $this->config->item('name_brand');
	...
	function identitaswebsite()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - ' . $this->config->item('name_brand');
	...
	function menuwebsite()
	{
		...
		$data['title'] = 'Menu Website - ' . $this->config->item('name_brand');
	...
	function tambah_menuwebsite()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - ' . $this->config->item('name_brand');
	...
	function edit_menuwebsite()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - ' . $this->config->item('name_brand');
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logowebsite()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - ' . $this->config->item('name_brand');
	...
	function slider()
	{
		...
		$data['title'] = 'Slider - ' . $this->config->item('name_brand');
	...
	function tambah_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - ' . $this->config->item('name_brand');
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - ' . $this->config->item('name_brand');
	...
	function halamanbaru()
	{
		...
		$data['title'] = 'Halaman - ' . $this->config->item('name_brand');
	...
	function tambah_halamanbaru()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - ' . $this->config->item('name_brand');
	...
	function edit_halamanbaru()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - ' . $this->config->item('name_brand');
	...
	function template()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Template - ' . $this->config->item('name_brand');
	...
	function artikel()
	{
		$data['title'] = 'Artikel - ' . $this->config->item('name_brand');
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - ' . $this->config->item('name_brand');
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - ' . $this->config->item('name_brand');
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	{
		$data['title'] = 'Kategori Artikel - ' . $this->config->item('name_brand');
		$data['record'] = $this->model_artikel->kategori_artikel();
	...
	function tagartikel()
	{
		$data['title'] = 'Tag - ' . $this->config->item('name_brand');
	...
	function tambah_tagartikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - ' . $this->config->item('name_brand');
	...
	function edit_tagartikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Tag - ' . $this->config->item('name_brand');
	...
	function edit_manajemenuser()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna - ' . $this->config->item('name_brand');
	...
	{
		$data['title'] = 'Manajemen Pengguna - ' . $this->config->item('name_brand');
	...
	function tambah_manajemenuser()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna - ' . $this->config->item('name_brand');
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - ' . $this->config->item('name_brand');
	...
	function berita()
	{
		...
		$data['title'] = 'Newsletter - ' . $this->config->item('name_brand');
	...
	function tambah_berita()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$ci->email->from($config['smtp_user'], $this->config->item('name_brand'));
			...
			$data['title'] = 'Kirim News Letter - ' . $this->config->item('name_brand');
	...
	function lihat_berita()
	{
		...
		$data['title'] = 'Detail Berita - ' . $this->config->item('name_brand');
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - ' . $this->config->item('name_brand');
