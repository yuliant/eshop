          ...
          <div class="card">
            ...
            <form action="<?= base_url('admin/tambah_supplier'); ?>" method="post">
              <div class="card-body">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nama Kontak Person</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Kode Pos (opsional)</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">No Telp (opsional)</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Fax (opsional)</label>
                  <div class="col-sm-6">
