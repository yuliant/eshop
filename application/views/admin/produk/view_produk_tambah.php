            ...
            <form action="<?= base_url('admin/tambah_produk') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type='text' class='form-control' name='c' placeholder="pcs" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <small>*gunakan satuan gram</small>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type='number' class='form-control' name='d' placeholder="6000" required>
                    <small>*input tanpa menggunakan simbol titik (.)</small>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type='number' class='form-control' name='f' placeholder="9000" required>
                    <small>*input tanpa menggunakan simbol titik (.)</small>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type='number' class='form-control' placeholder="5000" name='diskon'>
                    <small>*input tanpa menggunakan simbol titik (.)</small>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-file">
                      ...
                      <small>*maksimal upload 4mb</small>
                    </div>
                  </div>
                </div>
