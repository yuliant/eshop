  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <div class="bg-primary brand-link">
        <a href="">
          <img src="<?= base_url('assets/images/logo/logomini.png') ?>" alt="eshop" class="brand-image img-circle elevation-3 bg-white" style="opacity: .8">
    ...
    <footer class="main-footer">
      <strong>&copy; <?= date('Y') ?> <a href="<?php echo base_url() ?>" target="_BLANK"><?php echo $this->config->item('name_brand') ?></a></strong>
