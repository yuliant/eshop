...
<div class="wrapper w-100 mx-auto">
  ...
  <div class="row">
    ...
    <div class='col-lg-4 col-md-6'>
      ...
      <?php if ($proses == 'Pending') { ?>
        <form action="<?php echo base_url('konfirmasi') ?>" method="post">
          <input type="hidden" name="a" value="<?php echo $rows['kode_transaksi'] ?>" required>
          *silahkan lakukan konfirmasi pembayaran dengan menekan tombol ini
          <button class="btn btn-primary btn-sm " name="submit1" type="submit">Konfirmasi</button>
        </form>
      <?php } ?>
