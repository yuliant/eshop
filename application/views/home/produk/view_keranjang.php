    ...
    <div class="col-md-4">
      <div class="card w-100">
        <div class="card-body">
          ...
          <a class="btn btn-success btn-sm btn-block cart__checkout-button" href="<?= base_url('keranjang/checkouts') ?>">Proses checkout</a>
          <a class="btn btn-info btn-sm btn-block cart__checkout-button" href="<?= base_url('produk') ?>">Kembali Belanja</a>
        </div>
      </div>
    </div>
