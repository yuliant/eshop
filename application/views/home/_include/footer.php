    ...
    <div class="site-footer">
        <div class="container">
                            ...
                            <ul class="footer-contacts__contacts">
                                <table class="table table-borderless table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="mailto:<?= $iden['email'] ?>" target="_blank" rel="noopener noreferrer">
                                                <?= $iden['email'] ?>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://api.whatsapp.com/send?phone=<?php echo $iden['no_telp'] ?>&text=Assalamulaikum ?" target="_blank" rel="noopener noreferrer">
                                                <?= $iden['no_telp'] ?>
                                            </a>
                                        </td>
                                    </tr>
            ...
            <div class="site-footer__bottom">
                <div class="site-footer__copyright">&copy; <?= date('Y') ?> <a href="<?php echo base_url() ?>" target="_BLANK">Eshop</a></div>
                <div class="site-footer__payments">
                    <!-- <img src="<?= base_url('assets/template/tema/') ?>images/payments.png" alt=""> -->
                </div>
            </div>
        </div>
